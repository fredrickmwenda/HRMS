                ...
                return datatables()->of(Termination::with('company', 'employee')->get())
                    ...
                    ->addColumn('action', function ($data) {
                        ...
                        if ($termination_date > $current_date->setTime(0, 0, 0, 0)) {
                            ...
                            $button .= '<a href="'.route('terminations.restore', $data->id).'" class="btn btn-secondary btn-sm" data-bs-toggle="tooltip" data-placement="top" title="Restore Data"><i class="fa fa-undo"></i></button></a>';
                            $button .= '&nbsp;&nbsp;';
                        }
