				...
				return datatables()->of(Resignation::with('company', 'employee', 'department')->get())
					...
					->addColumn('action', function ($data)
					{
                        ...
                        if ($resignation_date > $current_date->setTime(0, 0, 0, 0)) {
                            ...
                            $button .= '<a href="'.route('resignations.restore', $data->id).'" class="btn btn-secondary btn-sm" data-bs-toggle="tooltip" data-placement="top" title="Restore Data"><i class="fa fa-undo"></i></button></a>';
                            $button .= '&nbsp;&nbsp;';
                        }
						return $button;
					})
