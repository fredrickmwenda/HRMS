           ...
           <div class="row">
               ...
               <div class="col-md-12">
                   ...
                   <div class="card-block">
                       <div id="accordion">
                           <div class="card mb-2">
                               <div class="card-header"> <a class="text-dark" data-bs-toggle="collapse" href="#basic_salary" aria-expanded="true"> <strong><span id="payslip_type"></span></strong> </a> </div>
                           ...
                           <div class="card mb-2">
                               <div class="card-header"> <a class="text-dark" data-bs-toggle="collapse" href="#pension" aria-expanded="true"> <strong>{{__('Pension')}}</strong></a> </div>
                           ...
                           <div class="card mb-2">
                               <div class="card-header"> <a class="text-dark collapsed" data-bs-toggle="collapse" href="#set_allowances" aria-expanded="false"> <strong>{{trans('file.Allowances')}}</strong></a> &nbsp; <a href="#" data-bs-toggle="popover" data-placement="top" data-content="If you don't set this month's amount, the last month's amount will be treated as this month"><i class="fa fa-exclamation-circle text-warning" aria-hidden="true"></i></a></div>
                           ...
                           <div class="card mb-2">
                               <div class="card-header"> <a class="text-dark collapsed" data-bs-toggle="collapse" href="#set_commissions" aria-expanded="false"> <strong>{{trans('file.Commissions')}}</strong></a> &nbsp; <a href="#" data-bs-toggle="popover" data-placement="top" data-content="If you don't set this month's amount, 0 amount will be treated as this month"><i class="fa fa-exclamation-circle text-warning" aria-hidden="true"></i></a> </div>
                           ...
                           <div class="card  mb-2">
                               <div class="card-header"> <a class="text-dark collapsed" data-bs-toggle="collapse" href="#set_loan_deductions" aria-expanded="false"> <strong>{{trans('file.Loan')}}</strong> </a> </div>
                           ...
                           <div class="card mb-2">
                               <div class="card-header"> <a class="text-dark collapsed" data-bs-toggle="collapse" href="#statutory_deductions" aria-expanded="false"> <strong>{{__('Statutory deductions')}}</strong></a> &nbsp; <a href="#" data-bs-toggle="popover" data-placement="top" data-content="If you don't set this month's amount, the last month's amount will be treated as this month"><i class="fa fa-exclamation-circle text-warning" aria-hidden="true"></i></a> </div>
                           ...
                           <div class="card mb-2">
                               <div class="card-header"> <a class="text-dark collapsed" data-bs-toggle="collapse" href="#set_other_payments" aria-expanded="false"> <strong>{{__('Other Payment')}}</strong></a> &nbsp; <a href="#" data-bs-toggle="popover" data-placement="top" data-content="If you don't set this month's amount, 0 amount will be treated as this month"><i class="fa fa-exclamation-circle text-warning" aria-hidden="true"></i></a> </div>
                           ...
                           <div class="card mb-2">
                               <div class="card-header"> <a class="text-dark collapsed" data-bs-toggle="collapse" href="#overtime" aria-expanded="false"> <strong>{{trans('file.Overtime')}}</strong></a> &nbsp; <a href="#" data-bs-toggle="popover" data-placement="top" data-content="If you don't set this month's amount, 0 amount will be treated as this month"><i class="fa fa-exclamation-circle text-warning" aria-hidden="true"></i></a> </div>
