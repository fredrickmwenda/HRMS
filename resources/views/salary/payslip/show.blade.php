                    ...
                    <div class="card mb-2">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="pull-right"><a href="{{route('payslip.pdf',$payslip->payslip_key)}}"
                                                       class="btn btn-default btn-sm" data-bs-toggle="tooltip"
                                                       data-placement="top" title=""
                                                       data-original-title="Download Payslip"><i
                                            class="fa fa-file-pdf-o"></i></a></div>
                        </div>
                        <div class="card-body">
                            <div class="d-flex justify-content-between collapse-head" data-bs-toggle="collapse"
            ...
            <div class="row mt-4">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div id="accordion">
                            <div class="card mb-2">
                                <div class="card-header"><a class="text-dark d-block" data-bs-toggle="collapse"
                            ...
                            @if($payslip->allowances)
                                <div class="card mb-2">
                                    <div class="card-header"><a class="text-dark collapsed d-block"
                                                                data-bs-toggle="collapse" href="#set_allowances"
                                                                aria-expanded="false">
                            ...
                            @if($payslip->commissions)
                                <div class="card mb-2">
                                    <div class="card-header"><a class="text-dark collapsed d-block"
                                                                data-bs-toggle="collapse" href="#set_commissions"
                                                                aria-expanded="false">
                            ...
                            @if($payslip->loans)
                                <div class="card  mb-2">
                                    <div class="card-header"><a class="text-dark collapsed d-block"
                                                                data-bs-toggle="collapse" href="#set_loan_deductions"
                                                                aria-expanded="false">
                            ...
                            @if($payslip->deductions)
                                <div class="card mb-2">
                                    <div class="card-header"><a class="text-dark collapsed d-block"
                                                                data-bs-toggle="collapse" href="#statutory_deductions"
                                                                aria-expanded="false">
                            ...
                            @if($payslip->other_payments)
                                <div class="card mb-2">
                                    <div class="card-header"><a class="text-dark collapsed d-block"
                                                                data-bs-toggle="collapse" href="#set_other_payments"
                                                                aria-expanded="false">
                            ...
                            <div class="card mb-2">
                                <div class="card-header"><a class="text-dark collapsed d-block"
                                                            data-bs-toggle="collapse" href="#set_annual_leave_info"
                                                            aria-expanded="false">
                            ...
                            @if($payslip->overtimes)
                                <div class="card mb-2">
                                    <div class="card-header"><a class="text-dark collapsed d-block"
                                                                data-bs-toggle="collapse" href="#overtime"
                                                                aria-expanded="false">
