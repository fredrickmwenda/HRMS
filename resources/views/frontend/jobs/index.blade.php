                ...
                <div class="job-listing card mb-5">
                    ...
                    <div class="card-footer">
                        <ul class="list-inline mb-0">
                            <li data-bs-toggle="tooltip" data-placement="top" title="{{$job_post->no_of_vacancy}} {{ __('vacancy') }}"><i class="dripicons-user-group"></i> {{$job_post->no_of_vacancy}}</li>
                            <li data-bs-toggle="tooltip" data-placement="top" title="{{$job_post->min_experience}} {{ __('of experience') }}"><i class="dripicons-calendar"></i> {{$job_post->min_experience}}</li>
                            <li data-bs-toggle="tooltip" data-placement="top" title="{{ __('posted') }} {{$job_post->updated_at->diffForHumans()}}"><i class="dripicons-clock"></i> {{$job_post->updated_at->diffForHumans()}}</li>
                        </ul>
                    </div>
                </div>
                @endforeach
