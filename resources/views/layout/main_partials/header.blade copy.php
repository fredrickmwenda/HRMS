        ...
        <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
                ...
                <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                    <li class="nav-item">
                        <a class="dropdown-header-name" style="padding-right: 10px" href="{{url('/optimize')}}" data-bs-toggle="tooltip" title="Clear all cache with refresh"><i class="fa fa-refresh"></i></a>
                    </li>
                    <li class="nav-item"><a id="btnFullscreen" data-bs-toggle="tooltip"
                                            title="{{__('Full Screen')}}"><i class="dripicons-expand"></i></a></li>
                    <li class="nav-item">
                        <a rel="nofollow" id="notify-btn" href="#" class="nav-link dropdown-item" data-bs-toggle="tooltip"
                    ...
                    <li class="nav-item">
                        <a rel="nofollow" href="#" class="nav-link dropdown-item" data-bs-toggle="tooltip"
                           title="{{__('Language')}}">
                ...
                @if (Auth::user()->role_users_id==1)
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/documentation')}}" target="_blank" data-bs-toggle="tooltip"
