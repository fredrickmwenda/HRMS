...
<head>
    ...
    <meta name="csrf-token" content="{{ csrf_token() }}">
     ...
     <link rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" href="{{ asset('miniadmin/css/bootstrap.min.css') }}">
     <noscript><link rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" href="{{ asset('miniadmin/css/bootstrap.min.css') }}"></noscript>
    <!-- Icons Css -->
    <link rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" href="{{ asset('miniadmin/css/icons.min.css')}}">
    <noscript><link rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" href="{{ asset('miniadmin/css/icons.min.css')}}"></noscript>
    ...
    <script type="text/javascript" src="{{ asset('miniadmin/libs/metismenu/metisMenu.min.js')}}"></script>
    <script type="text/javascript" src="{{ asset('miniadmin/libs/node-waves/waves.min.js')}}"></script>
    <script type="text/javascript" src="{{ asset('miniadmin/libs/feather-icons/feather.min.js')}}"></script>
...
<div id="layout-wrapper">
    ...
    @include('layout.main_partials.right')
...
<script type="text/javascript" src="{{ asset('miniadmin/js/app.js')}}"></script>
