        ...
        <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
                ...
                <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                    ...
                    <li class="nav-item">
                        <a rel="nofollow" href="#" class="nav-link dropdown-item" data-bs-toggle="tooltip" title="{{__('Language')}}">
    ...
    <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
                ...
                <li><a href="#Project_Management" aria-expanded="false" data-bs-toggle="collapse"> <i
                ...
                <li><a href="#invoices" aria-expanded="false" data-bs-toggle="collapse"> <i
