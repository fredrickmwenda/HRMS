        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between collapse-head" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="true" aria-controls="collapseExample">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="nav nav-tabs d-flex justify-content-between" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="discussions-tab" data-bs-toggle="tab" href="#Discussions"
                                       role="tab"
                                ...
                                <div class="tab-pane fade" id="Discussions" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseDiscussion" role="button" aria-expanded="false" aria-controls="collapseDiscussion">
                                                {{__('Post A Message')}}
                                            </a>
                                ...
                                <div class="tab-pane fade" id="Bugs" role="tabpanel" aria-labelledby="bugs-tab">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseBug" role="button" aria-expanded="false" aria-controls="collapseBug">
                                                {{__('Report A Bug')}}
                                            </a>
                                ...
                                <div class="tab-pane fade" id="Tasks" role="tabpanel" aria-labelledby="tasks-tab">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseTask" role="button" aria-expanded="false" aria-controls="collapseTask">
                                                {{__('Post A Task')}}
                                            </a>
                                ...
                                <div class="tab-pane fade" id="Files" role="tabpanel" aria-labelledby="files-tab">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseFile" role="button" aria-expanded="false" aria-controls="collapseFile">
                                                {{__('Insert A File')}}
                                            </a>
