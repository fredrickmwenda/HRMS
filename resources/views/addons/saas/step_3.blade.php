...
<html lang="en">
<head>
    <title>HRMS Installer | Step-3</title>
	...
	<div class="col-md-6 offset-md-3">
		<div class='wrapper'>
		    <header>
	            ...
	            <h1 class="text-center">HRMS SaaS Auto Installer</h1>
		    ...
		    <div class="content">
		        ...
		        <form action="{{ route('saas-install-process') }}" method="post">
                    @csrf
		            <fieldset>
						<label>Envato Purchase Code <a href="#purchasecodeModal" role="button" data-bs-toggle="modal">?</a></label>
		                ...
		                <input type='text' required placeholder="Ex: HRMSsaas" class="form-control" name="cpanel_username">

                        <label>Root Domain</label>
		                <input type='text' required placeholder="Ex: http://hrmsaas.com" class="form-control" name="central_domain">

                        <label>DB Prefix</label>
		                <input type='text' required placeholder="Ex: hrms_" class="form-control" name="db_prefix">
		                ...
		                <input type='text' required placeholder="Ex: hrms2024" class="form-control" name="db_username">

                        <label>Database Password</label>
		                <input type='password' required placeholder="Ex: PXsfdf1542" class="form-control" name="db_password">

                        <label>Database Name</label>
		                <input type='text' placeholder="Ex: hrmsaas_db" required class="form-control" name="db_name">
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <button type="button" class="btn-close" data-bs-ismiss="modal" aria-label="Close">
