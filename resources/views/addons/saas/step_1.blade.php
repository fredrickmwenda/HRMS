...
<html lang="en">
<head>
    <title>HRMS Installer | Step-1</title>
		...
		<div class="wrapper">
            ...
            <div class="content text-center">
                ...
                <div class="text-left">
                    ...
                    <p> <strong>N.B: </strong> If you want to use your HRMS existing database as a tenant after install then you have to follow the points given below -</p>
                    <ul>
                        <li>You have to backup your existing database according the instruction. Please read the <a href="" target="__blank">documentation</a> first.</li>
