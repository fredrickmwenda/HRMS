...
<html lang="en">
<head>
    <title>HRMS Installer | Step-2</title>
        ...
        <div class='wrapper'>
            ...
            <div class="content">
                ...
                if (version_compare(PHP_VERSION, '8.0') >= 0) {
                    ...
                    $ltext .= '<i class="fa fa-close"></i>HRMS needs at least PHP version  7.4, Your PHP Version is: ' . PHP_VERSION . '<br/>';
                    $passed .= '0';
                }
                ...
                <?php if ($passed == '1111'): ?>
                    ...
                    <h4>Great! System Test Completed. You can run HRMSSaaS on your server. Click Continue For Next Step.</h4>
                    <a href="{{ route('saas-install-step-3') }}" class="btn btn-primary">Continue</a>

                <?php else: ?>

                <br/><?php echo $ltext; ?><br/>Sorry. The requirements of HRMS is not available on your server. Please contact with us- hello@lion-coders.com with this code- <?php echo $passed; ?> Or contact with your server administrator.<br><br>
