        ...
        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">{{trans('file.Welcome')}} {{auth()->user()->username}}</h4>

                                    <div class="page-title-right">
                                    <h4 class="mb-sm-0 font-size-18">{{__('Today is')}} {{now()->englishDayOfWeek}} {{now()->format(env('Date_Format'))}}</h4>
                                    </div>
