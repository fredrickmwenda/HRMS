...
<head>
    <meta charset="utf-8">
    <title>HRMS - Attendance Device Addon</title>
    <meta name="description" content="Attendance Device Addon for HRMS- HR Management System" />
...
<div id="documenter_sidebar">
    <img src="{{ asset('docs/attendance_device_addon/assets/images/logo.png')}}" style="border: none;margin: 0 10px -10px;width: 40px">
    <h1 style="display: inline;margin-top: -10px">HRMS - Attendance Device Addon</h1>
...
<div id="documenter_content">
    ...
    <section id="documenter_cover">
        <h1>HRMS - Attendance Device Addon
        </h1>
        ...
        <p>HRMS - Attendance Device Addon extends our popular HR software HRMS to manage the attendance taken by the biometric device in your organization.
        </p>
    </section>
    <section id="requirement">
        ...
        <p>
            To integrate the addon, you need to have existing installation of our HR software HRMS.
        </p>
    </section>
    <section id="install">
        <div class="page-header">
        ...
        <p>
        Unzip the folder you downloaded from Codecanyon. Copy the 'resources' folder from it and delete the existing 'resources' folder from your project folder where hrms installed. Then paste the copied one.
        </p>
        <p>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/aJpehJfH3R0" title="HRMS - Attendance Device Addon" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </p>
        <p>
    ...
    <section id="how_to_use">
        ...
        <p>
            ...
            <img alt="" src="{{ asset('docs/attendance_device_addon/assets/images/1.png')}}">
        </p>
        <p>
            2. Set IP in the attendance device.
            <img alt="" src="{{ asset('docs/attendance_device_addon/assets/images/2.png')}}">
        </p>
        <p>
            3. Connect the device to device provider software. For example: connect ZKTeco to ZKTeco attendance software.
            <img alt="" src="{{ asset('docs/attendance_device_addon/assets/images/3.png')}}">
        </p>
        <p>
            4. Import employee list to device provider software.
            <img alt="" src="{{ asset('docs/attendance_device_addon/assets/images/4.png')}}">
        </p>
        <p>
            5. Add employee to device.
            <img alt="" src="{{ asset('docs/attendance_device_addon/assets/images/5.png')}}">
        </p>
        <p>
            6. Take attendance via device.
            <img alt="" src="{{ asset('docs/attendance_device_addon/assets/images/6.png')}}">
        </p>
        <p>
            7. Export attendance log from device provider software.
            <img alt="" src="{{ asset('docs/attendance_device_addon/assets/images/7.png')}}">
        </p>
        <p>
            8. Set attendance device date format in our software hrms.
            <img alt="" src="{{ asset('docs/attendance_device_addon/assets/images/8.png')}}">
        </p>
        <p>
            9. Import attendance log in our software hrms.
            <img alt="" src="{{ asset('docs/attendance_device_addon/assets/images/9.png')}}">
        </p>
    </section>
    <section id="video_tutorial">
        ...
        <p>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/OKSx1rjo88E" title="HRMS - Attendance Device Addon" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </section>
    <section id="support">
        <div class="page-header">
            <h3>SUPPORT</h3>
