    ...
    <div class="col-md-4">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-bs-toggle="tab"><small>{{__('Mark Attendance')}}</small></a></li>
                <li><a href="#tab_2" data-bs-toggle="tab">{{trans('Attendance')}} <small>{{trans('Overview')}}</small></a></li>
            </ul>
