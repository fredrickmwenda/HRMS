<div class="row">
    <div class="col-md-3">
        ...
        <ul class="nav nav-tabs vertical" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="employee_project-tab" data-bs-toggle="tab" href="#Employee_project"
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('employee_task.show',$employee)}}" id="employee_task-tab"
                   data-bs-toggle="tab" data-table="employee_task" data-target="#Employee_task" role="tab"
