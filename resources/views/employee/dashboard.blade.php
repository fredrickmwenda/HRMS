            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs d-flex justify-content-between" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="set_salary-tab" data-bs-toggle="tab" href="#Set_salary" role="tab"
                               aria-controls="Set_salary" aria-selected="false">{{__('Set Salary')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="leave-tab" data-bs-toggle="tab" href="#Leave" role="tab"
                               aria-controls="Leave" aria-selected="false">{{trans('file.Leave')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="employee_core_hr-tab" data-bs-toggle="tab" href="#Employee_Core_hr"
                               role="tab" aria-controls="Employee_Core_hr" aria-selected="false">{{__('Core HR')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="employee_project_task-tab" data-bs-toggle="tab"
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="employee_payslip-tab" data-bs-toggle="tab" href="#Employee_Payslip"
                               role="tab" aria-controls="Employee_Payslip"
                               aria-selected="false">{{trans('file.Payslip')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="remainingLeaveType-tab" data-bs-toggle="tab" href="#remainingLeaveType"
                                    ...
                                    <ul class="nav nav-tabs vertical" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('immigrations.show',$employee)}}"
                                               id="immigration-tab" data-bs-toggle="tab" data-table="immigration"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('contacts.show',$employee)}}"
                                               id="emergency-tab" data-bs-toggle="tab" data-table="emergency"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('social_profile.show',$employee)}}"
                                               id="social_profile-tab" data-bs-toggle="tab" data-table="social_profile"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('documents.show',$employee)}}"
                                               id="document-tab" data-bs-toggle="tab" data-table="document"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('qualifications.show',$employee)}}"
                                               id="qualification-tab" data-bs-toggle="tab" data-table="qualification"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('work_experience.show',$employee)}}"
                                               id="work_experience-tab" data-bs-toggle="tab" data-table="work_experience"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('bank_account.show',$employee)}}"
                                               id="bank_account-tab" data-bs-toggle="tab" data-table="bank_account"
