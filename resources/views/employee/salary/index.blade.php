            ...
            <ul class="nav nav-tabs vertical" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('salary_allowance.show',$employee)}}" id="salary_allowance-tab"
                       data-bs-toggle="tab" data-table="salary_allowance" data-target="#Salary_allowance" role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('salary_commission.show',$employee)}}" id="salary_commission-tab"
                       data-bs-toggle="tab" data-table="salary_commission" data-target="#Salary_commission" role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('salary_loan.show',$employee)}}" id="salary_loan-tab"
                       data-bs-toggle="tab" data-table="salary_loan" data-target="#Salary_loan" role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('salary_deduction.show',$employee)}}" id="salary_deduction-tab"
                       data-bs-toggle="tab" data-table="salary_deduction" data-target="#Salary_deduction" role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('other_payment.show',$employee)}}" id="other_payment-tab"
                       data-bs-toggle="tab" data-table="other_payment" data-target="#Other_payment" role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('salary_overtime.show',$employee)}}" id="salary_overtime-tab"
                       data-bs-toggle="tab" data-table="salary_overtime" data-target="#Salary_overtime" role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" id="salary_pension-tab"
                        data-bs-toggle="tab" data-table="salary_pension" data-target="#salary_pension" role="tab"
