               ...
               <div class="col-md-12">
                   ...
                   <div class="card-block">
                       <div id="accordion">
                           ...
                           <div class="card mb-2">
                               <div class="card-header"> <a class="text-dark collapsed" data-bs-toggle="collapse" href="#set_allowances" aria-expanded="false"> <strong>{{trans('file.Allowances')}}</strong></a> </div>
                           ...
                           <div class="card mb-2">
                               <div class="card-header"> <a class="text-dark collapsed" data-bs-toggle="collapse" href="#set_commissions" aria-expanded="false"> <strong>{{trans('file.Commissions')}}</strong></a> </div>
                           ...
                           <div class="card mb-2">
                               <div class="card-header"> <a class="text-dark collapsed" data-bs-toggle="collapse" href="#statutory_deductions" aria-expanded="false"> <strong>{{__('Statutory deductions')}}</strong></a> </div>
                           ...
                           <div class="card mb-2">
                               <div class="card-header"> <a class="text-dark collapsed" data-bs-toggle="collapse" href="#set_other_payments" aria-expanded="false"> <strong>{{__('Other Payment')}}</strong></a> </div>
                           ...
                           <div class="card mb-2">
                               <div class="card-header"> <a class="text-dark collapsed" data-bs-toggle="collapse" href="#overtime" aria-expanded="false"> <strong>{{trans('file.Overtime')}}</strong></a>  </div>
