<div class="row">
    <div class="col-md-3">
            ...
            <ul class="nav nav-tabs vertical" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="employee_award-tab" data-bs-toggle="tab" href="#Employee_award"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#Employee_travel" id="employee_travel-tab"
                       data-bs-toggle="tab" data-table="employee_travel" data-target="#Employee_travel" role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('employee_training.index',$employee)}}" id="employee_training-tab"
                       data-bs-toggle="tab" data-table="employee_training" data-target="#Employee_training" role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#Employee_ticket" id="employee_ticket-tab"
                       data-bs-toggle="tab" data-table="employee_ticket" data-target="#Employee_ticket" role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('employee_transfer.show',$employee)}}" id="employee_transfer-tab"
                       data-bs-toggle="tab" data-table="employee_transfer" data-target="#Employee_transfer" role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('employee_promotion.show',$employee)}}"
                       ...
                       data-bs-toggle="tab" data-table="employee_promotion" data-target="#Employee_promotion" role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('employee_complaint.show',$employee)}}"
                       ...
                       data-bs-toggle="tab" data-table="employee_complaint" data-target="#Employee_complaint" role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('employee_warning.show',$employee)}}" id="employee_warning-tab"
                       data-bs-toggle="tab" data-table="employee_warning" data-target="#Employee_warning" role="tab"
