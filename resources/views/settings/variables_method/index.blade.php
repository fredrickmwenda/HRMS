            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" href="{{route('travel_method.index')}}" id="Travel_method-tab" data-bs-toggle="tab" data-target="#Travel_method" role="tab" aria-controls="Travel_method" aria-selected="true">{{__('Arrangement Method')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="{{route('payment_method.index')}}" id="Payment_method-tab" data-bs-toggle="tab" data-table= "payment" data-target="#Payment_method" role="tab" aria-controls="Payment_method" aria-selected="false">{{__('Payment Type')}}</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{route('employee_qualification.index')}}" id="employee_qualification-tab" data-bs-toggle="tab" data-table= "employee_qualification" data-target="#employee_qualification" role="tab" aria-controls="employee_qualification" aria-selected="false">{{trans('file.Qualification')}}</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{route('job_categories.index')}}" id="Job_category-tab" data-bs-toggle="tab" data-table= "job_category" data-target="#job_category" role="tab" aria-controls="job_category" aria-selected="false">{{__('Job Category')}}</a>
                        </li>
                    </ul>
                </div>
            </div>
