            ...
            <div class="row">
                <div class="col-md-3">
                    <ul class="nav nav-tabs vertical" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="educationLevel-tab" data-bs-toggle="tab" href="#educationLevel"
                               role="tab" aria-controls="educationLevel"
                               aria-selected="true">{{__('Add Education Level')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#languageSkills"
                               id="languageSkills-tab" data-bs-toggle="tab" data-table="languageSkills"
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#otherSkills"
                               id="otherSkills-tab" data-bs-toggle="tab" data-table="otherSkills"
