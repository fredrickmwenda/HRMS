...
<div class="page-content">
        ...
        <div id="formModal" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" " aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">

                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title"><?php echo e(__('Add Admin')); ?></h5>
                        <button type="button" data-bs-dismiss="modal" id="btn-close" aria-label="Close" class="btn-close"></button>
                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="profile_photo"><?php echo e(__('Image')); ?></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <button type="submit" name="action_button" id="action_button"
                                                    class="btn btn-primary btn-block"><?php echo e(__('Add')); ?></button>
                                        </div>
                                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary"
                                data-bs-dismiss="modal"><?php echo e(trans('file.Cancel')); ?></button>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/basamiy/Documents/Projects/HRMs/peoplepro-1265/peopleprohrm/resources/views/all_user/index.blade.php ENDPATH**/ ?>