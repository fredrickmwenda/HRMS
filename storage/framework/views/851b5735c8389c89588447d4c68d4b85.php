<div id="projectModal" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <form method="post" id="project_sample_form" class="form-horizontal" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="title" id="project_title" required class="form-control" placeholder="<?php echo e(trans('file.Title')); ?>">
                        </div>
...
<?php /**PATH /home/basamiy/Documents/Projects/HRMs/peoplepro-1265/peopleprohrm/resources/views/calendarable/project.blade.php ENDPATH**/ ?>