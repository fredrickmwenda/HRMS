...
<head>
    ...
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
     ...
     <link rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" href="<?php echo e(asset('miniadmin/css/bootstrap.min.css')); ?>">
     <noscript><link rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" href="<?php echo e(asset('miniadmin/css/bootstrap.min.css')); ?>"></noscript>
    <!-- Icons Css -->
    <link rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" href="<?php echo e(asset('miniadmin/css/icons.min.css')); ?>">
    <noscript><link rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" href="<?php echo e(asset('miniadmin/css/icons.min.css')); ?>"></noscript>
    <link href="<?php echo e(asset('miniadmin/css/icons.min.css')); ?>" rel="stylesheet" type="text/css" />
    <!-- App Css-->
    <link href="<?php echo e(asset('miniadmin/css/app.min.css')); ?>" id="app-style" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="<?php echo e(asset('miniadmin/libs/jquery/jquery.min.js')); ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo e(asset('miniadmin/libs/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo e(asset('miniadmin/libs/metismenu/metisMenu.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('miniadmin/libs/node-waves/waves.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('miniadmin/libs/feather-icons/feather.min.js')); ?>"></script>
...
<div id="layout-wrapper">
    ...
    <?php echo $__env->make('layout.main_partials.right', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript" src="<?php echo e(asset('miniadmin/js/app.js')); ?>"></script>
...
<?php /**PATH /home/basamiy/Documents/Projects/HRMs/peoplepro-1265/peopleprohrm/resources/views/layout/main.blade.php ENDPATH**/ ?>