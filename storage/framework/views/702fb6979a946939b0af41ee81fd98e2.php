        ...
        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18"><?php echo e(trans('file.Welcome')); ?> <?php echo e(auth()->user()->username); ?></h4>

                                    <div class="page-title-right">
                                    <h4 class="mb-sm-0 font-size-18"><?php echo e(__('Today is')); ?> <?php echo e(now()->englishDayOfWeek); ?> <?php echo e(now()->format(env('Date_Format'))); ?></h4>
                                    </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/basamiy/Documents/Projects/HRMs/peoplepro-1265/peopleprohrm/resources/views/dashboard/admin_dashboard.blade.php ENDPATH**/ ?>