...
<script type="text/javascript">
    ...
    // Company--> Department  first select the company for department repopulation
    $('.dynamic').change(function () {
        if ($(this).val() !== '') {
    ...
    //Department--> Designation, Select the  Department then the designation
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/basamiy/Documents/Projects/HRMs/peoplepro-1265/peopleprohrm/resources/views/employee/index.blade.php ENDPATH**/ ?>